...
const manOutEl = document.querySelector("#manufacturing");
manOutEl.innerHTML = "<h1>Manufacturing Businesses</h1>";
...
manufacturingBusinesses.forEach((manufacture) => {
  manOutEl.innerHTML += `
          <h2>${manufacture.companyName}</h2>
    <section>
      ${manufacture.addressFullStreet}
      ${manufacture.addressCity}
      ${manufacture["addressStateCode"]}
      ${manufacture["addressZipCode"]}
    </section>
          `;
  manOutEl.innerHTML += "<hr/>";
});

const outEl2 = document.querySelector("#output2");
outEl2.innerHTML += "<h1>Purchasing Agents</h1>";
...
agents.forEach((agent) => {
  outEl2.innerHTML += `<h2>${agent.fullName}</h2>
  <section>
      ${agent.companyName}
      ${agent.phoneWork}
      </section>
